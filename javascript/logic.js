...
// if player has 3 X's in a row vertically, diagonally, and horizantally then alert X wins //
function winner() {
...
reset();
// if player has 3 O's in a row vertically, diagonally, and horizantally then alert O wins //
} else 
